...
\begin{itemize}
  ...
  \item We provide comprehensive comparisons against classical reactive planners (APF and Bug-type methods), value-based DRL baselines (DQN, D3QN), and state-of-the-art policy gradient methods (PPO).
\end{itemize}
