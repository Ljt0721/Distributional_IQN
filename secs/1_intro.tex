...
\begin{itemize}
  ...
  \item We provide comprehensive comparisons against classical reactive planners (APF and Bug-type methods) and value-based DRL baselines, including stronger deep RL baselines such as PPO and SAC.
\end{itemize}
