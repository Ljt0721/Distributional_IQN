...
Fig.~\ref{fig:intro_overview} shows a representative dynamic-flow scenario: existing methods either fail to complete the task safely (DQN, PPO) or struggle with extreme inefficiency (APF, Bug). The proposed IQN-based planner reaches the goal both safely and efficiently.
